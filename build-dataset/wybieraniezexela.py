...
EXCEL_PATH = r"C:\Users\danil\.vscode\praca\100_results_run-2.xlsx"
OUT_ROOT = Path(r"C:\Users\danil\.vscode\praca\grafyzexela")

TOPO_RE = re.compile(r"t(\d+_\d+)")
FLOAT_RE = re.compile(r"[-+]?(?:\d+\.\d+|\d+\.|\.\d+|\d+)(?:[eE][-+]?\d+)?")

SKIPPED_LOG_PATH = r"C:\Users\danil\.vscode\praca\grafyzexela\skipped_rows.txt"
